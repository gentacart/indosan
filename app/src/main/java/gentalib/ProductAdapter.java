...
import com.gcart.android.indosan.AppConfiguration;
import com.gcart.android.indosan.R;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Picasso.get().load("https://gentadb.com/pic/indosan/zip/" + product.getId() + ".jpg").memoryPolicy(MemoryPolicy.NO_CACHE,MemoryPolicy.NO_STORE).networkPolicy(NetworkPolicy.NO_CACHE).into(holder.imgProduct);
    }
